    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='users', to='fix_up.User')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contractor_after_picture', models.CharField(max_length=1000)),
